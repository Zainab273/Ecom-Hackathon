        ...
        <section className="lg:col-span-2">
          ...
          <article className="bg-white shadow rounded-lg overflow-hidden mb-6">
            <img
              ...
              alt="Blog Post 1: Millennial Design"
          ...
          <article className="bg-white shadow rounded-lg overflow-hidden mb-6">
            <img
              src="/images/r2.png"
              alt="Blog Post 2: Exploring New Ideas"
              className="w-full h-60 object-cover"
            />
            <div className="p-6">
          ...
          <article className="bg-white shadow rounded-lg overflow-hidden">
            <img
              src="/images/r3.png"
              alt="Blog Post 3: Handmade Pieces"
              className="w-full h-60 object-cover"
            />
            <div className="p-6">
            ...
            <ul className="space-y-4">
              <li>
                <a href="#" className="flex items-center space-x-4">
                  <img
                    src="/images/rp2.png"
                    alt="Recent Post 1: Sustainable Living"
              ...
              <li>
                <a href="#" className="flex items-center space-x-4">
                  <img
                    src="/images/rp.png"
                    alt="Recent Post 2: Trends in 2024"
                    className="w-16 h-16 object-cover rounded"
                  />
